...
if(!defined("NOTIFIER_THEME_NAME")) define( 'NOTIFIER_THEME_NAME', 'Expression' ); // The theme name
if(!defined("NOTIFIER_THEME_SHORTNAME")) define( 'NOTIFIER_THEME_SHORTNAME', 'expression' ); // The theme name
if(!defined("NOTIFIER_XML_FILE")) define( 'NOTIFIER_XML_FILE', 'http://pexeto.com/updates/expression.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
if(!defined("NOTIFIER_CACHE_INTERVAL")) define( 'NOTIFIER_CACHE_INTERVAL', 21600 ); // The time interval for the remote XML cache in the database (21600 seconds = 6 hours)
if(!defined("PEXETO_UPDATE_PAGE_NAME")) define ('PEXETO_UPDATE_PAGE_NAME', 'theme-update-notifier');
